...
SOURCE_ROWS = [
    ...
    {
        "source_id": "HI_SURVEYS",
        "priority": "gas_extent_asymmetry_memory_proxy",
        "url": "THINGS; LITTLE_THINGS; WALLABY; HALOGAS",
        "use_for_fields": "hi_extent_or_asymmetry; outer-disk gas support; warp/lopsided caveat; morphology-memory/history proxy support",
        "not_accepted_for_fields": "endpoint-selected readout family; 1D residual-derived morphology",
        "residual_blind_role": "gas morphology, extent, asymmetry, and history/memory-proxy support independent of rotation-score endpoints",
        "coverage_expectation": "heterogeneous overlap; survey-specific availability must be recorded per galaxy",
    },
    {
        "source_id": "PHANGS",
