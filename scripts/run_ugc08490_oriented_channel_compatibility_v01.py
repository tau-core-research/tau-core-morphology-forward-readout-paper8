#!/usr/bin/env python3
"""Run the frozen retrospective UGC08490 two-side channel-law preflight."""
...
SPARC = ROOT / "data" / "external" / "sparc" / "UGC08490_rotmod.dat"
REPORT = ROOT / "reports" / "ugc08490_oriented_channel_compatibility_v01.md"
C_KM_S = 299792.458
...
def main() -> None:
    freeze = json.loads((DATA / "ugc08490_oriented_channel_compatibility_freeze_v01.json").read_text())
    ...
    common.to_csv(DATA / "ugc08490_oriented_channel_compatibility_points_v01.csv", index=False)
    ...
    result = {
        "schema": "tau_core_ugc08490_oriented_channel_compatibility_v01",
    ...
    (DATA / "ugc08490_oriented_channel_compatibility_v01.json").write_text(json.dumps(result, indent=2) + "\n")
    REPORT.write_text(
        "# UGC08490 oriented-channel compatibility v01\n\n"
