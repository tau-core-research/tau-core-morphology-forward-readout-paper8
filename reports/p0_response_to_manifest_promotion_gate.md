...
Promotion gate decision: `READY_FOR_INDEPENDENT_ACCEPTED_MANIFEST_AUDIT`.
...
| --- | --- | --- | --- | --- | --- | --- |
| response_intake_complete | PASS | 0 | all P0 response rows pass the response intake validator | True | False | p0_response_to_manifest_promotion_gate_not_endpoint |
...
| review_confidence_present | PASS | 0 | review confidence is supplied for every P0 row | True | False | p0_response_to_manifest_promotion_gate_not_endpoint |
| family_recommendation_present | PASS | 0 | residual-blind family recommendation is supplied for every P0 row | True | False | p0_response_to_manifest_promotion_gate_not_endpoint |
| history_memory_judgment_present | PASS | 0 | morphological memory/history proxy judgment is supplied for every P0 row | True | False | p0_response_to_manifest_promotion_gate_not_endpoint |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| READY_FOR_INDEPENDENT_ACCEPTED_MANIFEST_AUDIT | 5 | 0 | 0 | True | False | False | p0_response_to_manifest_promotion_gate_not_endpoint |
