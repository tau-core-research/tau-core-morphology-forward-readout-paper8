...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| READOUT_LANE_FREEZE_GATE_COMPLETE_NOT_ENDPOINT | 4 | 3 | 0 | REJECTED_BY_CURRENT_EVIDENCE | False | False | 1 | readout_lane_freeze_gate_not_endpoint |
...
| NGC4183 | K_expdisk_overlay | L_projection_attenuation_weak_control_after_review | ACCEPTED_NULL_CONTROL_INTERVAL_ENDPOINT_COMPLETE | near-carrier/null-control projection bound after independent source review; frozen interval-control endpoint branch | strong projection endpoint; standalone added warp ramp; broad bar/core/history overlay | BLOCKED_REQUIRED_SOURCE_FIELDS_MISSING | gamma bound 0.00269837; velocity fractional bound 0.0013501; accepted interval endpoint complete | preserve narrow null-control claim boundary; do not reframe as mixed population validation | False | False | False | readout_lane_freeze_gate_not_endpoint |
